...
ActiveRecord::Schema[8.0].define(version: 2025_07_11_123618) do
  ...
  create_table "clans", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_clans_on_account_id"
  end
  ...
  add_foreign_key "clans", "accounts", on_delete: :cascade
